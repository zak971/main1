        ...
        <div className="mb-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {car.reviews && car.reviews.length > 0 && (
              <Badge className="bg-gradient-to-r from-gray-700 to-gray-800 text-gray-100 px-2 py-0.5 text-xs sm:text-sm font-medium shadow-sm border border-gray-600/30">
